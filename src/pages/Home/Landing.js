        ...
        <>
            <div class="hero h-screen lg:h-[60vh] bg-accent mt-16">
                <div class="hero-content flex-col lg:flex-row">
                    ...
                    <p data-aos="fade-right" data-aos-duration='1000' data-aos-delay='600' class="py-6 max-w-xl">Lorem Ipsum is simply dummy text of the pricinting and typesetting industry. Lorem Ipsum has</p>
                    <button data-aos="zoom-in" data-aos-delay='1000' class="btn btn-primary">Get Started</button>
                    </div>
            ...
            <div className='rounded-2xl mx-auto relative mt-[-50px] z-20 bg-base-200 shadow-lg p-10 w-5/6'>
